                ...
                <ul class="list">
                    <li class="item-cart">
                        <div class="product-img-wrap">
                            <a href="#" title="Product"><img src="{{('public')}}/img/product/cart_product_1.jpg" alt="Product" class="img-responsive"></a>
                        </div>
                    ...
                    <li class="item-cart">
                        <div class="product-img-wrap">
                            <a href="#" title="Product"><img src="{{('public')}}/img/product/cart_product_2.jpg" alt="Product" class="img-responsive"></a>
                        </div>
                        <div class="product-details">
                            <div class="inner-left">
                    ...
                    <ul class="js-filter">
                        <li class="filter filter-static hidden-xs hidden-sm">
                            <form class="form_newsletter" action="{{ url('shop/filter') }}" method="post">
                                @csrf
                                <input placeholder="search item" name="nama" class="newsletter-input form-control" value="{{ $nama ?? '' }}">
